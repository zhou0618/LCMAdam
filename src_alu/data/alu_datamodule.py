...
from src_alu import Config
class AluDataModule(LightningDataModule):

    def __init__(
        self,
        data_dir: str = "data/",
        # train_val_test_split: Tuple[int, int, int] = (55_000, 5_000, 10_000),
        train_val_test_split: Tuple[int, int, int] = (2_000, 100, 36),
        batch_size: int = 64,
        num_workers: int = 0,
...
if __name__ == "__main__":
    ...
    data = AluDataModule(data_dir="../../../../data/alu")
    data.setup()
